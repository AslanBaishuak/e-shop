          ...
          {sizes.map((sizes, index) => (
            <li key={index}>
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange("sizes", sizes, e.target.checked)
                }
              />
              {sizes}
            </li>
          ...
          {genders.map((genders, index) => (
            <li key={index}>
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange("genders", genders, e.target.checked)
                }
              />
              {genders}
            </li>
          ...
          {others.map((others, index) => (
            <li key={index}>
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange("others", others, e.target.checked)
                }
              />
              {others}
            </li>
